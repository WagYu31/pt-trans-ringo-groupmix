    ...
    <div className="wa-widget-wrapper">
      ...
      >
        {isOpen ? (
          ...
          <svg viewBox="0 0 24 24" width="28" height="28" className="wa-whatsapp-svg">
            <path
              fill="currentColor"
              d="M17.472 14.382c-.022-.08-.117-.146-.217-.196-.085-.043-.51-.252-.588-.28-.08-.03-.138-.043-.198.047-.06.09-.23.287-.282.348-.052.06-.105.067-.19.024-.315-.158-.69-.278-.97-.524-.265-.233-.508-.517-.594-.66-.085-.145-.01-.223.06-.295.068-.064.147-.173.222-.26.074-.085.1-.145.15-.24.05-.1.025-.187-.012-.26-.03-.08-.198-.48-.282-.68-.08-.194-.168-.168-.23-.172-.06-.003-.128-.003-.197-.003-.07 0-.18.026-.275.128-.097.102-.37.36-.37.88 0 .52.38 1.02.43 1.1.05.07.75 1.15 1.82 1.61.25.11.45.18.61.23.26.08.49.07.68.04.21-.03.58-.237.66-.467.08-.23.08-.43.056-.47-.024-.04-.086-.063-.17-.107zm-5.448-8.38c-3.87 0-7 3.13-7 7 0 1.24.32 2.46.94 3.53l-.1 1-.9.9 1-.1 1-.1c1.03.57 2.2.87 3.4.87 3.87 0 7-3.13 7-7 0-3.87-3.13-7-7-7zm0 13c-1.16 0-2.3-.3-3.32-.9l-.24-.14-2.43.25.26-2.37-.15-.24c-.65-1.04-.99-2.24-.99-3.48 0-3.31 2.69-6 6-6s6 2.69 6 6-2.69 6-6 6z"
            />
          </svg>
        )}
