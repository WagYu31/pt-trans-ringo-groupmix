    ...
    <div className="wa-widget-wrapper">
      ...
      >
        {isOpen ? (
          ...
          <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor" className="wa-whatsapp-svg">
            <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.717-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.97C16.328 1.966 13.861 1.93 12.01 1.93c-5.439 0-9.865 4.37-9.868 9.8-.001 1.77.463 3.5 1.34 5.01L2.483 20.35l3.864-1.01l.3.183zm13.111-6.195c-.328-.163-1.94-.947-2.24-1.055-.3-.108-.518-.163-.735.163-.217.327-.843 1.055-1.034 1.272-.19.217-.38.244-.707.081-.327-.163-1.38-.504-2.63-1.608-.97-.856-1.625-1.916-1.815-2.242-.19-.327-.02-.504.143-.667.147-.146.328-.382.492-.572.163-.19.217-.327.328-.545.109-.217.054-.408-.028-.572-.081-.163-.735-1.74-.993-2.394-.251-.61-.508-.53-.735-.541-.217-.011-.466-.013-.714-.013-.247 0-.65.092-.99.463-.338.37-1.288 1.252-1.288 3.05 0 1.797 1.32 3.534 1.503 3.778.183.244 2.582 3.905 6.273 5.474.877.372 1.56.594 2.09.76.88.277 1.68.238 2.31.144.7-.104 1.94-.784 2.215-1.503.275-.72.275-1.336.19-1.464-.083-.128-.3-.21-.627-.373z" />
          </svg>
        )}
